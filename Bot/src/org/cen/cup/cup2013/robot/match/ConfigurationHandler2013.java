...
public class ConfigurationHandler2013 extends ConfigurationHandler {
	...
	public ConfigurationHandler2013(IRobotServiceProvider servicesProvider) {
	...
	protected void updateConfiguration(ConfigurationReadResult result) {
		...
		data.setSide(result.getSwitch(SWITCH_MATCHSIDE) ? MatchSide.BLUE : MatchSide.RED);
