package org.cen.cup.cup2013.robot;
...
/**
 * Implementation of the robot factory for the cup 2013.
 */
public class RobotFactory2013 extends AbstractRobotFactory {
	...
	protected void initializeAttributes(IRobot robot) {
		...
		// match data
		MatchData data = new MatchData2013();
